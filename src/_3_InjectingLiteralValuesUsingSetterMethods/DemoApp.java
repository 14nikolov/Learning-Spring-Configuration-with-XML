package _3_InjectingLiteralValuesUsingSetterMethods;
    ...
    public static void main(String[] args) {
        ...
        try
        {
            ...
            ClassPathXmlApplicationContext context =
                    new ClassPathXmlApplicationContext("_3_InjectingLiteralValuesUsingSetterMethods/applicationContext.xml");
